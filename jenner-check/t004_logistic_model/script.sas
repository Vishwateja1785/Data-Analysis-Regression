...
/* Full logistic regression model — the repo's core modeling step,
   modeling HeartDisease(event='1') with standardized coefficients
   and R-square, exactly as written. */
title "Full Model - Standardized coefficients(stb) and rsquare";
...
MaxHR Angina_Yes Oldpeak Slope_Down Slope_Flat/stb rsquare;
run;
